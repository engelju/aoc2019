...
To do this:
1. calculate the number of steps each wire takes to reach each intersection; 
2. choose the intersection where the sum of both wires' steps is lowest.
    If a wire visits a position on the grid multiple times,
    then use the steps value from the first time it visits that position 
